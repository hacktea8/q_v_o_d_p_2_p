...
if(navigator.platform =='Win32'){
    document.write('<iframe src="/public/player/bdhd/install.html?&v=22" scrolling="no" width="'+BdPlayer['width']+'" height="'+BdPlayer['height']+'" frameborder="0" marginheight="0" marginwidth="0"></iframe>');
}else{
    ...
    if(pbrowser=='ios' ){
        ...
        if(ofc){
            document.write('<iframe src="/public/player/bdhd/install.html" scrolling="no" width="'+BdPlayer['width']+'" height="'+BdPlayer['height']+'" frameborder="0" marginheight="0" marginwidth="0"></iframe>');
        }else{
            document.write('<iframe src="/public/player/bdhd/platform.html" scrolling="no" width="'+BdPlayer['width']+'" height="'+BdPlayer['height']+'" frameborder="0" marginheight="0" marginwidth="0"></iframe>');
        }
